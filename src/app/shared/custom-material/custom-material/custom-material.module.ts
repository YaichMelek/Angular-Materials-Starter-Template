...
@NgModule({
  ...
  imports: [
    ...
    MatExpansionModule, DragDropModule, MatSortModule, MatFormFieldModule, MatGridListModule,
    MatSliderModule, MatRadioModule, MatStepperModule
  ],
  exports: [
    CommonModule,
    MatSidenavModule, MatIconModule, MatToolbarModule, MatButtonModule,
    ...
    MatGridListModule, MatSliderModule, MatRadioModule, MatStepperModule
  ],
})
